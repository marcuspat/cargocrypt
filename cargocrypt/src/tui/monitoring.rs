...
use ratatui::{
    ...
    text::{Line, Span},
    widgets::{BarChart, Block, Borders, Gauge, List, ListItem, Paragraph, Row, Table, Tabs, Wrap},
    Frame, Terminal,
};
use std::sync::Arc;
...
impl MonitoringDashboard {
    ...
    fn render_metrics(&self, f: &mut Frame, area: Rect) {
        ...
        let crypto_data = vec![("Encrypt", 15), ("Decrypt", 12), ("KeyGen", 3)];
        ...
        let file_data = vec![("Read", 25), ("Write", 18), ("Delete", 2)];
        ...
        let alerts = vec![
            ListItem::new(vec![
                ...
                Line::from(vec![
                    ...
                    Span::styled(
                        "Encryption taking 2.3s (threshold: 1.0s)",
